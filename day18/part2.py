...
"""
Optimization idea (not implemented):

With some kind of binary search, we could
get closer to the number of iteration that blocks the path
to the exit.
"""
...
def main() -> None:
    # value = 12  # example.txt
    value = 1024  # input.txt
    while True:
        value += 1

        # print("#", value)
        # m = Maze("example.txt", size=7, lines_to_process=value)
        m = Maze("input.txt", size=71, lines_to_process=value)
